...
server_ip = "185.218.125.35"
server_username = "root"
server_password = "cub15ardorgrass"
...
# 5. Копирование содержимого папки dist в /var/www/new_calc
stdin, stdout, stderr = ssh_client.exec_command('sudo rm -rf /var/www/new_calc')
stdout.channel.recv_exit_status()
stdin, stdout, stderr = ssh_client.exec_command('sudo mkdir /var/www/new_calc')
stdout.channel.recv_exit_status()

stdin, stdout, stderr = ssh_client.exec_command('sudo cp -r /root/dist/* /var/www/new_calc/')
stdout.channel.recv_exit_status()
